...
class CategoryEditForm extends StatelessWidget {
  ...
  const CategoryEditForm({super.key, required this.category});
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.loadCategoryForEditing(category);
      if (category.image != null) {
        imageUrlPreview.value = category.image!;
      }
    });
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () => controller.editCategory(category.id!),
